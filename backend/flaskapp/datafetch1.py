...
symbols = ['RELIANCE', 'TCS', 'INFY', 'HDFC', 'ICICIBANK', 'HINDUNILVR', 'HDFCBANK', 'BAJFINANCE', 'KOTAKBANK', 
           'BHARTIARTL', 'ITC', 'LT', 'AXISBANK', 'ASIANPAINT', 'SBIN', 'MARUTI', 'ULTRACEMCO', 'SUNPHARMA', 
           'NTPC', 'TITAN', 'WIPRO', 'M&M', 'HCLTECH', 'NESTLEIND', 'TECHM', 'POWERGRID', 'ADANIPORTS', 'HDFCLIFE', 
...
# Insert each stock into the Asset table if not exists
for symbol in symbols:
    cursor.execute("""
        INSERT INTO Asset (name) VALUES (%s) 
